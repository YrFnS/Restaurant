...
async function seed() {
  ...
  const menuItems = [
    ...
    { nameEn: "Lamb Chops", nameAr: "ريش لحم", descriptionEn: "Premium lamb chops with rosemary and mint sauce", descriptionAr: "ريش لحم فاخرة مع إكليل الجبل وصلصة النعناع", price: 32.99, categoryId: grills.id, isSpecial: true, dietary: "halal", calories: 580, preparationTime: 25, image: "/images/menu/grills.jpg" },
