    ...
    >
      ...
      <div className="flex items-center justify-between h-11 px-3">
        ...
        <div className="flex items-center gap-1">
          <LanguageToggle size="sm" className="h-7 w-7 p-0 text-white/80 hover:text-white hover:bg-white/15" variant="label" />
          <ThemeToggle size="sm" className="h-7 w-7 p-0 text-white/80 hover:text-white hover:bg-white/15" />
